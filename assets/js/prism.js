/* PrismJS 1.22.0
https://prismjs.com/download.html#themes=prism-tomorrow&languages=markup+css+clike+javascript+bash+c+css-extras+docker+git+go+graphql+handlebars+ignore+json+json5+markdown+markup-templating+mongodb+nginx+powershell+python+jsx+tsx+regex+rust+sql+typescript+typoscript+vim+yaml&plugins=line-numbers+inline-color+match-braces */
